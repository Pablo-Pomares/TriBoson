...
// Sun Nov 10 18:44:42 2024 by ROOT version 6.32.04
// from TTree Events/Events
// found on file: root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/127C2975-1B1C-A046-AABF-62B77E757A86.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nIsoTrack;
   Float_t         IsoTrack_dxy[24];   //[nIsoTrack]
   Float_t         IsoTrack_dz[24];   //[nIsoTrack]
   Float_t         IsoTrack_eta[24];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_all[24];   //[nIsoTrack]
   Float_t         IsoTrack_pfRelIso03_chg[24];   //[nIsoTrack]
   Float_t         IsoTrack_phi[24];   //[nIsoTrack]
   Float_t         IsoTrack_pt[24];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_all[24];   //[nIsoTrack]
   Float_t         IsoTrack_miniPFRelIso_chg[24];   //[nIsoTrack]
   Int_t           IsoTrack_charge[24];   //[nIsoTrack]
   Int_t           IsoTrack_fromPV[24];   //[nIsoTrack]
   Int_t           IsoTrack_pdgId[24];   //[nIsoTrack]
   Bool_t          IsoTrack_isHighPurityTrack[24];   //[nIsoTrack]
   Bool_t          IsoTrack_isPFcand[24];   //[nIsoTrack]
   Bool_t          IsoTrack_isFromLostTrack[24];   //[nIsoTrack]
   UInt_t          nJet;
   Float_t         Jet_area[34];   //[nJet]
   Float_t         Jet_btagCSVV2[34];   //[nJet]
   Float_t         Jet_btagDeepB[34];   //[nJet]
   Float_t         Jet_btagDeepCvB[34];   //[nJet]
   Float_t         Jet_btagDeepCvL[34];   //[nJet]
   Float_t         Jet_btagDeepFlavB[34];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[34];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[34];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[34];   //[nJet]
   Float_t         Jet_chEmEF[34];   //[nJet]
   Float_t         Jet_chFPV0EF[34];   //[nJet]
   Float_t         Jet_chHEF[34];   //[nJet]
   Float_t         Jet_eta[34];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[34];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[34];   //[nJet]
   ...
   UChar_t         Jet_nConstituents[34];   //[nJet]
   ...
   Int_t           Proton_multiRP_arm[1];   //[nProton_multiRP]
   UInt_t          nMuon;
   Float_t         Muon_dxy[22];   //[nMuon]
   Float_t         Muon_dxyErr[22];   //[nMuon]
   Float_t         Muon_dxybs[22];   //[nMuon]
   Float_t         Muon_dz[22];   //[nMuon]
   Float_t         Muon_dzErr[22];   //[nMuon]
   Float_t         Muon_eta[22];   //[nMuon]
   Float_t         Muon_ip3d[22];   //[nMuon]
   Float_t         Muon_jetPtRelv2[22];   //[nMuon]
   Float_t         Muon_jetRelIso[22];   //[nMuon]
   Float_t         Muon_mass[22];   //[nMuon]
   Float_t         Muon_miniPFRelIso_all[22];   //[nMuon]
   Float_t         Muon_miniPFRelIso_chg[22];   //[nMuon]
   Float_t         Muon_pfRelIso03_all[22];   //[nMuon]
   Float_t         Muon_pfRelIso03_chg[22];   //[nMuon]
   Float_t         Muon_pfRelIso04_all[22];   //[nMuon]
   Float_t         Muon_phi[22];   //[nMuon]
   Float_t         Muon_pt[22];   //[nMuon]
   Float_t         Muon_ptErr[22];   //[nMuon]
   Float_t         Muon_segmentComp[22];   //[nMuon]
   Float_t         Muon_sip3d[22];   //[nMuon]
   Float_t         Muon_softMva[22];   //[nMuon]
   Float_t         Muon_tkRelIso[22];   //[nMuon]
   Float_t         Muon_tunepRelPt[22];   //[nMuon]
   Float_t         Muon_mvaLowPt[22];   //[nMuon]
   Float_t         Muon_mvaTTH[22];   //[nMuon]
   Int_t           Muon_charge[22];   //[nMuon]
   Int_t           Muon_jetIdx[22];   //[nMuon]
   Int_t           Muon_nStations[22];   //[nMuon]
   Int_t           Muon_nTrackerLayers[22];   //[nMuon]
   Int_t           Muon_pdgId[22];   //[nMuon]
   Int_t           Muon_tightCharge[22];   //[nMuon]
   Int_t           Muon_fsrPhotonIdx[22];   //[nMuon]
   UChar_t         Muon_highPtId[22];   //[nMuon]
   Bool_t          Muon_highPurity[22];   //[nMuon]
   Bool_t          Muon_inTimeMuon[22];   //[nMuon]
   Bool_t          Muon_isGlobal[22];   //[nMuon]
   Bool_t          Muon_isPFcand[22];   //[nMuon]
   Bool_t          Muon_isStandalone[22];   //[nMuon]
   Bool_t          Muon_isTracker[22];   //[nMuon]
   UChar_t         Muon_jetNDauCharged[22];   //[nMuon]
   Bool_t          Muon_looseId[22];   //[nMuon]
   Bool_t          Muon_mediumId[22];   //[nMuon]
   Bool_t          Muon_mediumPromptId[22];   //[nMuon]
   UChar_t         Muon_miniIsoId[22];   //[nMuon]
   UChar_t         Muon_multiIsoId[22];   //[nMuon]
   UChar_t         Muon_mvaId[22];   //[nMuon]
   UChar_t         Muon_mvaLowPtId[22];   //[nMuon]
   UChar_t         Muon_pfIsoId[22];   //[nMuon]
   UChar_t         Muon_puppiIsoId[22];   //[nMuon]
   Bool_t          Muon_softId[22];   //[nMuon]
   Bool_t          Muon_softMvaId[22];   //[nMuon]
   Bool_t          Muon_tightId[22];   //[nMuon]
   UChar_t         Muon_tkIsoId[22];   //[nMuon]
   Bool_t          Muon_triggerIdLoose[22];   //[nMuon]
   UInt_t          nPhoton;
   ...
   Int_t           Proton_singleRP_decRPId[3];   //[nProton_singleRP]
   UInt_t          nSubJet;
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[53];   //[nTrigObj]
   Float_t         TrigObj_eta[53];   //[nTrigObj]
   Float_t         TrigObj_phi[53];   //[nTrigObj]
   Float_t         TrigObj_l1pt[53];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[53];   //[nTrigObj]
   Float_t         TrigObj_l2pt[53];   //[nTrigObj]
   Int_t           TrigObj_id[53];   //[nTrigObj]
   Int_t           TrigObj_l1iso[53];   //[nTrigObj]
   Int_t           TrigObj_l1charge[53];   //[nTrigObj]
   Int_t           TrigObj_filterBits[53];   //[nTrigObj]
   UInt_t          nOtherPV;
   ...
   UChar_t         Muon_cleanmask[22];   //[nMuon]
   ...
   Bool_t          HLT_L1MinimumBiasHF_OR_part0;
   Bool_t          HLT_L1MinimumBiasHF_OR_part1;
   Bool_t          HLT_L1MinimumBiasHF_OR_part2;
   Bool_t          HLT_L1MinimumBiasHF_OR_part3;
   Bool_t          HLT_L1MinimumBiasHF_OR_part4;
   Bool_t          HLT_L1MinimumBiasHF_OR_part5;
   Bool_t          HLT_L1MinimumBiasHF_OR_part6;
   Bool_t          HLT_L1MinimumBiasHF_OR_part7;
   Bool_t          HLT_L1MinimumBiasHF_OR_part8;
   Bool_t          HLT_L1MinimumBiasHF_OR_part9;
   ...
   Bool_t          L1_CastorGap_BptxAND;
   Bool_t          L1_CastorHaloMuon;
   Bool_t          L1_CastorHaloMuon_BptxAND;
   Bool_t          L1_CastorHighJet_BptxAND;
   Bool_t          L1_CastorMediumJet_BptxAND;
   ...
   Bool_t          HLT_DiJetVBF_PassThrough;
   Bool_t          HLT_DiJetVBFMu_PassThrough;
   Bool_t          L1_SingleJet12;
   Bool_t          L1_SingleJet4;
   Bool_t          L1_SingleJet8;
   ...
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part0;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part1;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part2;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part3;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part4;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part5;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part6;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part7;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part8;   //!
   TBranch        *b_HLT_L1MinimumBiasHF_OR_part9;   //!
   ...
   TBranch        *b_L1_CastorGap_BptxAND;   //!
   TBranch        *b_L1_CastorHaloMuon;   //!
   TBranch        *b_L1_CastorHaloMuon_BptxAND;   //!
   ...
   TBranch        *b_HLT_DiJetVBF_PassThrough;   //!
   TBranch        *b_HLT_DiJetVBFMu_PassThrough;   //!
   TBranch        *b_L1_SingleJet12;   //!
   TBranch        *b_L1_SingleJet4;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/127C2975-1B1C-A046-AABF-62B77E757A86.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eospublic.cern.ch//eos/opendata/cms/Run2016H/DoubleMuon/NANOAOD/UL2016_MiniAODv2_NanoAODv9-v1/2510000/127C2975-1B1C-A046-AABF-62B77E757A86.root");
      }
...
void Events::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part0", &HLT_L1MinimumBiasHF_OR_part0, &b_HLT_L1MinimumBiasHF_OR_part0);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part1", &HLT_L1MinimumBiasHF_OR_part1, &b_HLT_L1MinimumBiasHF_OR_part1);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part2", &HLT_L1MinimumBiasHF_OR_part2, &b_HLT_L1MinimumBiasHF_OR_part2);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part3", &HLT_L1MinimumBiasHF_OR_part3, &b_HLT_L1MinimumBiasHF_OR_part3);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part4", &HLT_L1MinimumBiasHF_OR_part4, &b_HLT_L1MinimumBiasHF_OR_part4);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part5", &HLT_L1MinimumBiasHF_OR_part5, &b_HLT_L1MinimumBiasHF_OR_part5);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part6", &HLT_L1MinimumBiasHF_OR_part6, &b_HLT_L1MinimumBiasHF_OR_part6);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part7", &HLT_L1MinimumBiasHF_OR_part7, &b_HLT_L1MinimumBiasHF_OR_part7);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part8", &HLT_L1MinimumBiasHF_OR_part8, &b_HLT_L1MinimumBiasHF_OR_part8);
   fChain->SetBranchAddress("HLT_L1MinimumBiasHF_OR_part9", &HLT_L1MinimumBiasHF_OR_part9, &b_HLT_L1MinimumBiasHF_OR_part9);
   ...
   fChain->SetBranchAddress("L1_CastorGap_BptxAND", &L1_CastorGap_BptxAND, &b_L1_CastorGap_BptxAND);
   fChain->SetBranchAddress("L1_CastorHaloMuon", &L1_CastorHaloMuon, &b_L1_CastorHaloMuon);
   fChain->SetBranchAddress("L1_CastorHaloMuon_BptxAND", &L1_CastorHaloMuon_BptxAND, &b_L1_CastorHaloMuon_BptxAND);
   ...
   fChain->SetBranchAddress("HLT_DiJetVBF_PassThrough", &HLT_DiJetVBF_PassThrough, &b_HLT_DiJetVBF_PassThrough);
   fChain->SetBranchAddress("HLT_DiJetVBFMu_PassThrough", &HLT_DiJetVBFMu_PassThrough, &b_HLT_DiJetVBFMu_PassThrough);
   fChain->SetBranchAddress("L1_SingleJet12", &L1_SingleJet12, &b_L1_SingleJet12);
   fChain->SetBranchAddress("L1_SingleJet4", &L1_SingleJet4, &b_L1_SingleJet4);
